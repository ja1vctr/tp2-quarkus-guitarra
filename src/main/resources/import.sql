...
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('A clássica Stratocaster com melhorias modernas.', 'Fender Stratocaster American Professional II', 12500.00, 10, true, 1, 1, 'Alder', 3.5, 6, 1, 1, 2, 3, 1, 1, 1);

-- Guitarra 2: Gibson Les Paul
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('O som icônico do rock and roll.', 'Gibson Les Paul Standard 60s', 18900.00, 5, true, 2, 8, 'Mahogany', 4.2, 6, 2, 4, 5, 2, 2, 2);

-- Guitarra 3: Ibanez RG
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Velocidade e precisão para o metal moderno.', 'Ibanez RG550', 7800.00, 8, true, 3, 16, 'Basswood', 3.2, 6, 3, 6, 7, 8, 3, 3, 3);

-- Guitarra 4: Fender Telecaster
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('O som estalado e clássico da Telecaster.', 'Fender Telecaster Player Series', 6800.00, 12, true, 1, 2, 'Alder', 3.6, 6, 1, 1, 3, 2, 1, 1);

-- Guitarra 5: Gibson SG Standard
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Leve, potente e pronta para o rock.', 'Gibson SG Standard', 14500.00, 7, true, 2, 9, 'Mahogany', 3.1, 6, 2, 4, 5, 1, 2, 2);

-- Guitarra 6: Ibanez S Series
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Corpo fino, leve e som versátil.', 'Ibanez S671ALB', 8200.00, 9, true, 3, 17, 'Nyatoh', 2.9, 6, 3, 6, 7, 8, 2, 3, 3);

-- Guitarra 7: Fender Jazzmaster
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Visual vintage e som único, ideal para indie e alternativo.', 'Fender Jazzmaster Vintera 60s', 9500.00, 6, true, 1, 3, 'Alder', 3.8, 6, 1, 1, 3, 3, 1, 1);

-- Guitarra 8: Gibson Les Paul Custom
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('O ápice do luxo e do som, a "Black Beauty".', 'Gibson Les Paul Custom', 25000.00, 3, true, 2, 10, 'Mahogany', 4.5, 6, 2, 4, 5, 2, 2, 2);

-- Guitarra 9: Ibanez AZ
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Versatilidade moderna para todos os estilos.', 'Ibanez AZ2402', 13500.00, 5, true, 3, 18, 'Alder', 3.3, 6, 3, 6, 7, 8, 1, 3, 3);

-- Guitarra 10: Fender Stratocaster (Black)
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('A icônica Stratocaster em um acabamento preto clássico.', 'Fender Stratocaster Player (Black)', 6500.00, 15, true, 1, 1, 'Alder', 3.5, 6, 1, 1, 2, 3, 2, 1, 1);

-- Guitarra 11: Gibson Les Paul (White)
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Uma Les Paul com um visual clean e moderno.', 'Gibson Les Paul Studio (White)', 11000.00, 8, true, 2, 11, 'Mahogany', 4.0, 6, 2, 4, 5, 3, 2, 2);

-- Guitarra 12: Ibanez RG (Sunburst)
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Uma RG com um toque clássico no acabamento.', 'Ibanez RG421HPAM', 5500.00, 10, true, 3, 16, 'Nyatoh', 3.1, 6, 3, 6, 7, 8, 1, 3, 3);

-- Guitarra 13: Fender Jaguar
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Escala curta e circuito complexo para timbres únicos.', 'Fender Jaguar Player Series', 7200.00, 7, true, 1, 4, 'Alder', 3.7, 6, 1, 1, 3, 1, 1, 1);

-- Guitarra 14: Gibson Flying V
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Design radical e som agressivo para o metal.', 'Gibson Flying V', 15500.00, 4, true, 2, 12, 'Mahogany', 3.4, 6, 2, 4, 5, 2, 2, 2);

-- Guitarra 15: Ibanez 7 Cordas
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Explore novas profundezas com 7 cordas.', 'Ibanez RG7421', 4900.00, 11, true, 3, 19, 'Meranti', 3.6, 7, 3, 6, 8, 3, 3, 3);

-- Guitarra 16: Fender Stratocaster HSS
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('A versatilidade da Strat com a potência de um humbucker na ponte.', 'Fender Stratocaster Player HSS', 6950.00, 18, true, 1, 6, 'Alder', 3.6, 6, 1, 1, 2, 8, 3, 1, 1);

-- Guitarra 17: Gibson ES-335
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('A semi-acústica definitiva para blues, jazz e rock.', 'Gibson ES-335', 22000.00, 5, true, 2, 13, 'Maple/Poplar/Maple', 3.9, 6, 2, 4, 5, 1, 2, 2);

-- Guitarra 18: Ibanez Artcore
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Guitarra semi-acústica com ótimo custo-benefício.', 'Ibanez AS73', 4500.00, 13, true, 3, 20, 'Linden', 3.8, 6, 2, 6, 8, 1, 2, 3);

-- Guitarra 19: Fender Mustang
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Pequena, confortável e cheia de atitude.', 'Fender Mustang 90', 5800.00, 9, true, 1, 5, 'Alder', 3.2, 6, 1, 1, 3, 3, 1, 1);

-- Guitarra 20: Gibson Explorer
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Outro design icônico e agressivo da Gibson.', 'Gibson Explorer', 16000.00, 4, true, 2, 14, 'Mahogany', 4.1, 6, 2, 4, 5, 3, 2, 2);

-- Guitarra 21: Ibanez Iceman
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Visual único e som pesado, famosa por Paul Stanley.', 'Ibanez Iceman PS120', 9800.00, 6, true, 3, 21, 'Mahogany', 4.0, 6, 2, 6, 8, 2, 2, 3);

-- Guitarra 22: Fender Stratocaster (7 Cordas)
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_meio, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Uma Stratocaster para a era moderna do metal.', 'Fender Stratocaster 7-String', 15000.00, 3, true, 1, 7, 'Alder', 3.9, 7, 1, 1, 2, 8, 1, 1, 1);

-- Guitarra 23: Gibson Firebird
INSERT INTO Guitarra (descricao, nome, preco, quantidade, status, id_marca, id_modelo, madeira, peso, numeroDeCordas, id_braco, id_captador_braco, id_captador_ponte, id_cor, id_ponte, id_tarracha) 
VALUES ('Design "reverse" e mini-humbuckers para um timbre brilhante.', 'Gibson Firebird', 17500.00, 4, true, 2, 15, 'Mahogany/Walnut', 4.0, 6, 2, 4, 5, 1, 2, 2);